  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group
        ...
        // position={[0, 0, -0.01]} rotation-x={[-Math.PI / 2, 0, 0]}
      >
...
export default function App() {
  return (
    <>
      <Canvas dpr={[1, 2]} camera={{ position: [-5, 0, -25], fov: 35 }}>
      ...
      <Canvas dpr={[1, 2]} camera={{ position: [-10, 0, -25], fov: 35 }}>
        ...
        <ContactShadows rotation-y={Math.PI / 2} position={[0, -4.5, 0]} opacity={1} width={20} height={20} blur={2} far={4.5} />
        <OrbitControls enablePan={false} enableZoom={false} minPolarAngle={Math.PI / 2} maxPolarAngle={Math.PI} />
      </Canvas>

      <Canvas
        dpr={[1, 2]}
        camera={{ position: [-5, 10, -0], fov: 35 }}
        style={{
        ...
        <ambientLight />
        <pointLight position={[10, 120, 0]} intensity={1.0} />
        <Suspense fallback={null}>
          <group rotation={[20, Math.PI, 0]}>
            <TvModel />
            {/* <NewTheatre /> */}
          </group>
          <Environment preset="city" />
        ...
        <ContactShadows rotation-x={Math.PI / 2} position={[0, -4.5, 0]} opacity={1} width={20} height={20} blur={2} far={4.5} />
        {/* <OrbitControls /> */}
        <OrbitControls enablePan={false} enableZoom={false} minPolarAngle={-1} maxPolarAngle={Math.PI} />
      </Canvas>
      <Loader />
      <Loader />
    </>
